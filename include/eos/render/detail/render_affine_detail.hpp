...
inline void raster_triangle_affine(TriangleToRasterize triangle, core::Image4u& colourbuffer,
                                   ...
                                   std::vector<Eigen::Vector4f>* tri_vertices_coords_3d_before_projection = 0,
                                   core::Image3d* coordsbuffer = 0, core::Image2d* texcoordsbuffer = 0)
{
        ...
        for (int xi = triangle.min_x; xi <= triangle.max_x; ++xi)
        {
            ...
            if (alpha >= 0 && beta >= 0 && gamma >= 0)
            {
                ...
                if (z_affine < depthbuffer(pixel_index_row, pixel_index_col))
                {
					...
					// CZ: update coordsbuffer
					if (tri_vertices_coords_3d_before_projection != 0 && coordsbuffer != 0) {
						(*coordsbuffer)(pixel_index_row, pixel_index_col)[0] = alpha * static_cast<double>((*tri_vertices_coords_3d_before_projection)[0](0)) + beta * static_cast<double>((*tri_vertices_coords_3d_before_projection)[1](0)) + gamma * static_cast<double>((*tri_vertices_coords_3d_before_projection)[2](0));
						(*coordsbuffer)(pixel_index_row, pixel_index_col)[1] = alpha * static_cast<double>((*tri_vertices_coords_3d_before_projection)[0](1)) + beta * static_cast<double>((*tri_vertices_coords_3d_before_projection)[1](1)) + gamma * static_cast<double>((*tri_vertices_coords_3d_before_projection)[2](1));
						(*coordsbuffer)(pixel_index_row, pixel_index_col)[2] = alpha * static_cast<double>((*tri_vertices_coords_3d_before_projection)[0](2)) + beta * static_cast<double>((*tri_vertices_coords_3d_before_projection)[1](2)) + gamma * static_cast<double>((*tri_vertices_coords_3d_before_projection)[2](2));
					}

					// CZ: update texcoordsbuffer
					if (texcoordsbuffer != 0) {
						(*texcoordsbuffer)(pixel_index_row, pixel_index_col)[0] = alpha * static_cast<double>(triangle.v0.texcoords[0]) + beta * static_cast<double>(triangle.v1.texcoords[0]) + gamma * static_cast<double>(triangle.v2.texcoords[0]);
						(*texcoordsbuffer)(pixel_index_row, pixel_index_col)[1] = alpha * static_cast<double>(triangle.v0.texcoords[1]) + beta * static_cast<double>(triangle.v1.texcoords[1]) + gamma * static_cast<double>(triangle.v2.texcoords[1]);
					}
                }
            }
        }
