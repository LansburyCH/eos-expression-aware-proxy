...
std::array<T, 3> get_vertex_colour(const morphablemodel::PcaModel& colour_model, int vertex_id,
                                   const T* const colour_coeffs, int num_color_coeffs);
...
struct LandmarkCost
{
    ...
    LandmarkCost(const morphablemodel::PcaModel& shape_model,
                 ...
                 bool use_perspective, int num_shape_coeffs, int num_blendshape_coeffs)
                    ...
                    const T* const shape_coeffs, const T* const blendshape_coeffs, T* residual) const
    {
        ...
        const auto point_arr =
            get_shape_point<T>(shape_model, blendshapes, vertex_id, shape_coeffs, blendshape_coeffs, num_shape_coeffs, num_blendshape_coeffs);
...
struct ImageCost
{
    ...
    ImageCost(const morphablemodel::MorphableModel& morphable_model,
              ...
              bool use_perspective, int num_shape_coeffs, int num_blendshape_coeffs, int num_color_coeffs)
        : morphable_model(morphable_model), blendshapes(blendshapes), image(image),
          ...
          use_perspective(use_perspective), num_shape_coeffs(num_shape_coeffs), num_blendshape_coeffs(num_blendshape_coeffs), num_color_coeffs(num_color_coeffs)
    {
                    ...
                    const T* const color_coeffs, T* residual) const
    {
        ...
        const auto point_arr = get_shape_point<T>(morphable_model.get_shape_model(), blendshapes, vertex_id,
                                                  shape_coeffs, blendshape_coeffs, num_shape_coeffs, num_blendshape_coeffs);
        ...
        } else
        {
            ...
            auto model_colour = get_vertex_colour(morphable_model.get_color_model(), vertex_id, color_coeffs, num_color_coeffs);
...
std::array<T, 3> get_vertex_colour(const morphablemodel::PcaModel& color_model, int vertex_id,
                                   const T* const color_coeffs, int num_color_coeffs)
{
